...
const APP_ID = "9a09f374d7c44caca3f8561f05b0281d";
...
Future<void> _initAgoraRtcEngine() async {
  ...
  //await AgoraRtcEngine.setClientRole(widget.call.role);
}
  ...
  addPostFrameCallback() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      callStreamSubscription = callMethods
          .callStream(uid: myUser.id.toString())
                  ...
                  children: [
                    Flexible(
                      child: Container(
                        ...
                        child: Text(
                            _infoStrings[index]+ _users.length.toString()+ widget.call.channelId.toString() ,// _infoStrings[index],
