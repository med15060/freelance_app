...
class SellerSearch extends StatelessWidget {
  SellerSearch({Key key, this.data}) : super(key: key);
  final Seller data;
  @override
  Widget build(BuildContext context) {
    return Container(
              ...
              children: <Widget>[
                ClipOval(
                  child: new SizedBox(
                    ...
                    width: 40.0,
                    height: 40.0,
                    child: data.profile==null? Image.asset('assets/images/profile.png'
                    ) :Image.network(BASE_URL +data.profile
                      ,
                      fit: BoxFit.fill,
                ...
                InkWell( child: Text(
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Profile(user:data
                        )),
                  );
