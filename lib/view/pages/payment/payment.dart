...
class Paypal extends StatefulWidget {
  ...
  Paypal({Key key, this.id}) : super(key: key);

  @override
  _PaypalState createState() => _PaypalState(id:this.id);
...
//            onPressed: () => Scaffold.of(context).openDrawer()),
   ...
   FutureBuilder(
        future:Api().AcceptOffer(this.id),
    builder: (BuildContext context, AsyncSnapshot<Order> snapshot) {
          print("here is it");
      print(snapshot.data.url_payment);
    ...
    children: <Widget>[
    WebView(
    initialUrl:snapshot.data.url_payment.toString(),
    onPageFinished: (data){
    updateLoading(false);
    },
